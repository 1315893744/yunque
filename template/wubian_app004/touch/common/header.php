...
<link rel="stylesheet" href="template/wubian_app004/touch/common/style.css" type="text/css" media="all">
<script src="template/wubian_app004/touch/common/jquery.min.js?{VERHASH}"></script>
