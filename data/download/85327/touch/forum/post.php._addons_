...
<div class="wp">
	<div class="post_from">
		<ul class="cl">
			...
			<textarea class="pt" id="needmessage" tabindex="3" autocomplete="off" id="{$editorid}_textarea" name="$editor[textarea]" cols="80" rows="6"  placeholder="{lang thread_content}" fwin="reply">$postinfo[message]</textarea>
			</li>
			<li style="padding:0;">
