...
0
|| checktplrefresh('./template/quater_6_ui/common/header.htm', './template/quater_6_ui/common/header_common.htm', 1600756028, '28', './data/template/29_28_common_header_forum_forumdisplay.tpl.php', './template/quater_6_ui', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/quater_6_ui/common/header.htm', './template/quater_6_ui/common/pubsearchform.htm', 1600756028, '28', './data/template/29_28_common_header_forum_forumdisplay.tpl.php', './template/quater_6_ui', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/quater_6_ui/common/header.htm', './template/default/common/header_qmenu.htm', 1600756028, '28', './data/template/29_28_common_header_forum_forumdisplay.tpl.php', './template/quater_6_ui', 'common/header_forum_forumdisplay')
;?>
...
<base href="<?php echo $_G['siteurl'];?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_29_common.css?<?php echo VERHASH;?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_29_forum_forumdisplay.css?<?php echo VERHASH;?>" /><?php if($_G['uid'] && isset($_G['cookie']['extstyle']) && strpos($_G['cookie']['extstyle'], TPLDIR) !== false) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['cookie']['extstyle'];?>/style.css" /><?php } elseif($_G['style']['defaultextstyle']) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['style']['defaultextstyle'];?>/style.css" /><?php } ?>    <script src="template/quater_6_ui/src/js/jquery.min.js" type="text/javascript"></script>
...
<div id="Quater_headtop" <?php if($_GET['diy'] == 'yes' && check_diy_perm($topic)) { ?>class="hides"<?php } ?>>
  <div class="wp cl">
  ...
  <div id="Quater_bar" class="cl"> 
    <div class="wp cl">
      <!-- 站点LOGO -->
      <div class="hd_logo"> 
         <?php $mnid = getcurrentnav();?> <h2><a href="forum.php"><img src="template/quater_6_ui/src/logo.png" /></a></h2>
      </div>
      <!-- 导航 -->
      <div class="nav">
        <ul>
        ...
        <div class="Quater_user_info">
          ...
          <div class="user-link">
            <ul>
              ...
              <?php if($_G['uid']) { ?>
              <div class="cl" style="float: left; width: 200px; border-top: 1px dotted #E6E6E6; padding: 10px 0; margin-top: 8px;">
...
<li class="daoju"><?php echo $nav['code'];?></li>
<?php } ?>
   <?php } ?>
              </div>
          <?php } ?>
  <?php if(!empty($_G['setting']['pluginhooks']['global_myitem_extra'])) echo $_G['setting']['pluginhooks']['global_myitem_extra'];?>
      ...
      <div class="Quater_user">
        <div class="Quater_user_info">
          <div class="user-main ">
            <div class="avatar"> <img src="template/quater_6_ui/src/noLogin.jpg" alt="" height="32" width="32"></div>
            <span class="nickname"><?php echo $_G['member']['username'];?></span><span class="arrow"></span></div>
          <div class="user-link">
            <ul>
      ...
      <div class="Quater_user lg_box" style="margin-left: 30px;">
       <ul>
              <li class="z" style="margin-right: 0; overflow: hidden;"><a href="member.php?mod=logging&amp;action=login" class="log1" style="color: #3498db;"><i></i>登录</a></li>
              <li class="z reg"><a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="reg1" style="padding-left: 3px; color: #E2E5EA;"><i></i> / 注册</a></li>
       </ul>
      </div>
...
jQuery('.quater_search').slideUp(300);
    ...
    <div class="th_post y cl" style="display: none;"><a onClick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发新帖" style="margin: 0;">发布</a></div>
    </div>
  </div>
</div>
...
</ul><?php echo adshow("headerbanner/wp a_h");?><?php echo adshow("subnavbanner/a_mu");?><?php if(!empty($_G['setting']['pluginhooks']['global_header'])) echo $_G['setting']['pluginhooks']['global_header'];?> 
<?php } ?>
