...
0
|| checktplrefresh('./template/comiis_app/touch/forum/viewthread_node.htm', './template/comiis_app/touch/forum/comiis_view_cnxh.htm', 1600854668, '36', './data/template/37_36_touch_forum_viewthread_node.tpl.php', './template/comiis_app', 'touch/forum/viewthread_node')
;?>
<?php if($_G['forum_thread']['isgroup'] == 1) { $comiis_app_switch['comiis_view_reply'] = $comiis_app_switch['comiis_view_reply_group'];?><?php } $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);?><?php if(!empty($_G['setting']['pluginhooks']['viewthread_posttop_mobile'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_posttop_mobile'][$postcount];?>
