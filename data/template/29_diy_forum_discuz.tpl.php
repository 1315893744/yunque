<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz');?><?php include template('common/header'); ?><script src="template/quater_6_ui/src/js/jquery.superslide.js" type="text/javascript" type="text/javascript"></script>
...
<div id="pt" class="bm cl" style="padding: 0;">
...
<div class="wp cl" style="margin: 0;"> 
  ...
  <div class="mn cl" style="float: left; width: 100%;">
    ...
    <div class="cl" style="box-shadow: 0 0 3px rgba(0,0,0,.1);">
    <?php if(empty($gid)) { ?>
    <div id="chart" class="bm mb10 cl" style="padding: 20px 25px; margin: 0; border-radius: 0; border-top: 1px solid 0; border-bottom: 1px solid #F1F1F1; background: #F9F9F9; box-shadow: none;">
    ...
    <?php } ?>
    <div class="Framebox cl" style="width: 1130pxpx; padding: 10px 25px; border-radius: 0; background: #FFFFFF; box-shadow: none; overflow: hidden;">
...
slideImgTexts[<?php echo $k; ?>] = '<?php echo $svalue['subject'];?>';<?php $k++;?><?php } ?>
        ...
        <div id="category_0" class="bm_c myfav_img" style="<?php echo $collapse['category_0']; ?>">
          <table cellspacing="0" cellpadding="0" class="fl_tb">
            ...
            <tr class="fl_row"> 
              <?php } ?> 
              <?php } ?>
              <dl class="fl_g" style="float: left; width: 260px; padding-right: 0; margin: 15px 0;">
                  <?php if($forum['icon']) { ?> 
                  <?php echo $forum['icon'];?> 
                  <?php } else { ?> 
                  <a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } ?> style="float: left;"><img src="<?php echo $_G['style']['styleimgdir'];?>/forum<?php if($forum['folder']) { ?>_new<?php } ?>.gif" alt="<?php echo $forum['name'];?>" /></a> 
                  <?php } ?> 
                </div>
  ...
  <div id="main_sidebar" style="width: 310px; display: none;">
   <?php if(!empty($_G['setting']['pluginhooks']['index_side_top'])) echo $_G['setting']['pluginhooks']['index_side_top'];?>
        <div class="cl" style="height: auto; margin: 0; overflow: visible;">
