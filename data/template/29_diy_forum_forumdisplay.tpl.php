...
0
|| checktplrefresh('./template/quater_6_ui/forum/forumdisplay.htm', './template/quater_6_ui/forum/forumdisplay_leftside.htm', 1600756028, 'diy', './data/template/29_diy_forum_forumdisplay.tpl.php', './template/quater_6_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/quater_6_ui/forum/forumdisplay.htm', './template/quater_6_ui/forum/recommend.htm', 1600756028, 'diy', './data/template/29_diy_forum_forumdisplay.tpl.php', './template/quater_6_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/quater_6_ui/forum/forumdisplay.htm', './template/quater_6_ui/common/seccheck.htm', 1600756028, 'diy', './data/template/29_diy_forum_forumdisplay.tpl.php', './template/quater_6_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/quater_6_ui/forum/forumdisplay.htm', './template/quater_6_ui/forum/forumdisplay_list.htm', 1600756028, 'diy', './data/template/29_diy_forum_forumdisplay.tpl.php', './template/quater_6_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/quater_6_ui/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1600756028, 'diy', './data/template/29_diy_forum_forumdisplay.tpl.php', './template/quater_6_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/quater_6_ui/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1600756028, 'diy', './data/template/29_diy_forum_forumdisplay.tpl.php', './template/quater_6_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/quater_6_ui/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1600756028, 'diy', './data/template/29_diy_forum_forumdisplay.tpl.php', './template/quater_6_ui', 'forum/forumdisplay')
;?><?php include template('common/header'); ?><script src="template/quater_6_ui/src/js/jquery.superslide.js" type="text/javascript" type="text/javascript"></script>
<?php if($_G['forum']['ismoderator']) { ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_moderate.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } ?>
<div id="pt" class="bm cl">
   <div class="z" style="padding-right: 0;"><a href="forum.php"<?php if($_G['setting']['forumjump']) { ?> id="fjump" onmouseover="delayShow(this, 'showForummenu(<?php echo $_G['fid'];?>)');" class="showmenu" <?php } ?>><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?></div>
</div>
...
<?php if($_G['forum']['icon']) { ?><div class="forum_top_icon cl"><img src="data/attachment/common/<?php echo $_G['forum']['icon'];?>" alt="<?php echo $_G['forum']['name'];?>"></div><?php } ?>
                <div class="forum_right cl" <?php if($_G['forum']['icon']) { ?>style="width: 1020px;"<?php } else { ?>style="width: 1040px; padding-left: 20px;"<?php } ?>>
            ...
            <p id="forum_rules_<?php echo $_G['fid'];?>"><?php echo $_G['forum']['description'];?></p> 
            <?php } else { ?> 
            <p>板块介绍填写区域，请于后台编辑</p>
            <?php } ?>
          ...
          <?php } ?>          
                    ...
                    <div class="forum_top_info cl">
                    	<span class="z">
                    	<?php if(!$subforumonly) { ?>今日 : <?php echo $_G['forum']['todayposts'];?><span class="pipe">|</span>主题 : <?php echo $_G['forum']['threads'];?><?php if($_G['forum']['rank']) { } } ?>
                        <?php if($moderatedby) { ?><span class="pipe">|</span>版主: <?php echo $moderatedby;?><?php } ?>
                        </span>
                        <span class="y">
                            <a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum&amp;formhash=<?php echo FORMHASH;?>" id="a_favorite" class="fa_fav" onclick="showWindow(this.id, this.href, 'get', 0);">收藏本版 <em class="xi1" id="number_favorite" <?php if(!$_G['forum']['favtimes']) { ?> style="display:none;"<?php } ?>>(<span id="number_favorite_num"><?php echo $_G['forum']['favtimes'];?></span>)</em></a>
...
<?php } ?>
  ...
  <div id="main_sidebar">
     ...
     <?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_postbutton_top'])) echo $_G['setting']['pluginhooks']['forumdisplay_postbutton_top'];?>
        <?php if($subexists) { include template('forum/forumdisplay_subforum'); } ?>
...
<div class="forum-left cl" style="padding: 0; border-radius: 0; box-shadow: 0 0 3px rgba(0,0,0,.1); overflow: visible; background: #FFFFFF;">
    ...
    <div class="mn" style="padding-top: 0; width: 100% !important;">
...
<?php } ?>
      ...
      <div class="bm bmw fl<?php if($_G['forum']['forumcolumns']) { ?> flg<?php } ?>" style="padding: 0 25px;">
        <div class="bm_h cl"> <span class="o cl"><img id="recommendgroups_<?php echo $_G['forum']['fid'];?>_img" src="<?php echo IMGDIR;?>/<?php echo $collapseimg['recommendgroups'];?>" title="收起/展开" alt="收起/展开" onclick="toggle_collapse('recommendgroups_<?php echo $_G['forum']['fid'];?>');" /></span>
...
getnewlivepostlist();
  ...
  <div class="display_hd cl">
      ...
      <div id="threadlist" class="tl bm bmw"<?php if($_G['uid']) { ?> style="position: relative; margin-bottom: 0;"<?php } ?>>
...
<div class="th showmenubox">
        <div class="y">
            ...
            <?php } ?> 
            <span id="atarget" <?php if($_G['cookie']['atarget'] > 0) { ?>onclick="setatarget(-1)" class="atarget_1"<?php } else { ?>onclick="setatarget(1)"<?php } ?> title="在新窗口中打开帖子" style="margin-right: 0;">新窗</span> 
        </div>
...
<tbody id="separatorline" class="emptb"><tr><td class="icn"></td><?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?><td class="o cl"></td><?php } ?><th></th><?php if(CURMODULE == 'guide') { ?><td class="by"></td><?php } ?><td class="by"></td><td class="num"></td><td class="by"></td></tr></tbody>
...
<th style="border-right: 1px solid #EEEEEE;"><?php if(empty($_G['forum']['picstyle']) && $_GET['orderby'] == 'lastpost' && !$_GET['filter']) { ?><a href="javascript:;" onclick="checkForumnew_btn('<?php echo $_G['fid'];?>')" title="查看更新" class="forumrefresh">版块主题</a><?php } else { ?>&nbsp;<?php } ?></th>
</tr>
</tbody>
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/image_s.gif" alt="attach_img" title="图片附件" align="absmiddle" />
<?php } elseif($thread['attachment'] == 1) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/common.gif" alt="attachment" title="附件" align="absmiddle" />
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/digest_<?php echo $thread['digest'];?>.png" align="absmiddle" alt="digest" title="精华 <?php echo $thread['digest'];?>" />
<?php } if($thread['displayorder'] == 0) { if($thread['recommendicon'] && $filter != 'recommend') { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/recommend_<?php echo $thread['recommendicon'];?>.gif" align="absmiddle" alt="recommend" title="评价指数 <?php echo $thread['recommends'];?>" />
<?php } if($thread['heatlevel']) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/hot_<?php echo $thread['heatlevel'];?>.gif" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
<?php } if($thread['rate'] > 0) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/agree.gif" align="absmiddle" alt="agree" title="帖子被加分" />
<?php } elseif($thread['rate'] < 0) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/disagree.gif" align="absmiddle" alt="disagree" title="帖子被减分" />
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/folder_lock.gif" />
<?php } elseif($thread['special'] == 1) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/pollsmall.gif" alt="投票" />
<?php } elseif($thread['special'] == 2) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/tradesmall.gif" alt="商品" />
<?php } elseif($thread['special'] == 3) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/rewardsmall.gif" alt="悬赏" />
<?php } elseif($thread['special'] == 4) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/activitysmall.gif" alt="活动" />
<?php } elseif($thread['special'] == 5) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/debatesmall.gif" alt="辩论" />
<?php } elseif(in_array($thread['displayorder'], array(1, 2, 3, 4))) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/quater_forum/pin_<?php echo $thread['displayorder'];?>.gif" alt="<?php echo $_G['setting']['threadsticky'][3-$thread['displayorder']];?>" />
<?php } ?>
</a>
...
<?php } } ?>
                                      ...
                                      <span style="margin-left: 0;"><?php echo $thread['author'];?></span></a><span style="margin-left: 5px;">@ <?php echo $thread['dateline'];?></span>
</i>
...
<ul id="waterfall" class="ml waterfall cl" style="margin-left: 20px;"><?php if(is_array($_G['forum_threadlist'])) foreach($_G['forum_threadlist'] as $key => $thread) { if(!$thread['forumstick'] && ($thread['isgroup'] == 1 || $thread['fid'] != $_G['fid'])) { if($thread['related_group'] == 0 && $thread['closed'] > 1) { $thread[tid]=$thread[closed];?><?php } } $waterfallwidth = $_G[setting][forumpicstyle][thumbwidth];?><li style="width:<?php echo $waterfallwidth;?>px;">
<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>
...
<a class="bm_h" href="javascript:;" rel="<?php echo $multipage_more;?>" curpage="<?php echo $page;?>" id="autopbn" totalpage="<?php echo $maxpage;?>" picstyle="<?php echo $_G['forum']['picstyle'];?>" forumdefstyle="<?php echo $_G['cookie']['forumdefstyle'];?>">下一页</a>
...
<ul class="p_pop" id="newspecial_menu" style="display: none">
  ...
  <li><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>">发表帖子</a></li>
  <?php } ?> 
  <?php if($_G['forum']['threadsorts'] && !$_G['forum']['allowspecialonly']) { ?> 
  <?php if(is_array($_G['forum']['threadsorts']['types'])) foreach($_G['forum']['threadsorts']['types'] as $id => $threadsorts) { ?> 
  <?php if($_G['forum']['threadsorts']['show'][$id]) { ?>
  ...
  <li class="poll"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=1">发起投票</a></li>
  <?php } ?> 
  <?php if($_G['group']['allowpostreward']) { ?>
  <li class="reward"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=3">发布悬赏</a></li>
  <?php } ?> 
  <?php if($_G['group']['allowpostdebate']) { ?>
  <li class="debate"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=5">发起辩论</a></li>
  <?php } ?> 
  <?php if($_G['group']['allowpostactivity']) { ?>
  <li class="activity"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=4">发起活动</a></li>
  <?php } ?> 
  <?php if($_G['group']['allowposttrade']) { ?>
  <li class="trade"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=2">出售商品</a></li>
  <?php } ?> 
  <?php if($_G['setting']['threadplugins']) { ?> 
  <?php if(is_array($_G['forum']['threadplugin'])) foreach($_G['forum']['threadplugin'] as $tpid) { ?> 
  <?php if(array_key_exists($tpid, $_G['setting']['threadplugins']) && @in_array($tpid, $_G['group']['allowthreadplugin'])) { ?>
...
<?php if(empty($_G['setting']['disfixednv_forumdisplay']) ) { ?><script>fixed_top_nv();</script><?php } ?> <?php include template('common/footer'); ?> 
