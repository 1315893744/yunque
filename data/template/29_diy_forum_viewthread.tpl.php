...
0
|| checktplrefresh('./template/quater_6_ui/forum/viewthread.htm', './template/quater_6_ui/forum/viewthread_node_author_info.htm', 1600750039, 'diy', './data/template/29_diy_forum_viewthread.tpl.php', './template/quater_6_ui', 'forum/viewthread')
|| checktplrefresh('./template/quater_6_ui/forum/viewthread.htm', './template/quater_6_ui/forum/viewthread_fastpost.htm', 1600750039, 'diy', './data/template/29_diy_forum_viewthread.tpl.php', './template/quater_6_ui', 'forum/viewthread')
|| checktplrefresh('./template/quater_6_ui/forum/viewthread.htm', './template/quater_6_ui/forum/viewthread_node.htm', 1600750039, 'diy', './data/template/29_diy_forum_viewthread.tpl.php', './template/quater_6_ui', 'forum/viewthread')
|| checktplrefresh('./template/quater_6_ui/forum/viewthread.htm', './template/quater_6_ui/forum/viewthread_node_body.htm', 1600750039, 'diy', './data/template/29_diy_forum_viewthread.tpl.php', './template/quater_6_ui', 'forum/viewthread')
|| checktplrefresh('./template/quater_6_ui/forum/viewthread.htm', './template/default/common/seditor.htm', 1600750039, 'diy', './data/template/29_diy_forum_viewthread.tpl.php', './template/quater_6_ui', 'forum/viewthread')
|| checktplrefresh('./template/quater_6_ui/forum/viewthread.htm', './template/default/common/upload.htm', 1600750039, 'diy', './data/template/29_diy_forum_viewthread.tpl.php', './template/quater_6_ui', 'forum/viewthread')
|| checktplrefresh('./template/quater_6_ui/forum/viewthread.htm', './template/quater_6_ui/forum/seccheck_post.htm', 1600750039, 'diy', './data/template/29_diy_forum_viewthread.tpl.php', './template/quater_6_ui', 'forum/viewthread')
|| checktplrefresh('./template/quater_6_ui/forum/viewthread.htm', './template/quater_6_ui/forum/viewthread_node_body.htm', 1600750039, 'diy', './data/template/29_diy_forum_viewthread.tpl.php', './template/quater_6_ui', 'forum/viewthread')
|| checktplrefresh('./template/quater_6_ui/forum/viewthread.htm', './template/quater_6_ui/common/seccheck.htm', 1600750039, 'diy', './data/template/29_diy_forum_viewthread.tpl.php', './template/quater_6_ui', 'forum/viewthread')
;?><?php include template('common/header'); $close_leftinfo = 1;?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<div id="pt" class="bm cl">
                <div class="z"><a href="forum.php"><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?> <em>&rsaquo;</em> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>">查看内容</a> </div>
                <?php if(!IS_ROBOT) { ?>
                <div class="y" style="display: none;"> 
                  ...
                  <?php } ?> 
                  <a href="forum.php?mod=redirect&amp;goto=nextoldset&amp;tid=<?php echo $_G['tid'];?>" title="上一主题"><img src="<?php echo IMGDIR;?>/thread-prev.png" alt="上一主题" class="vm" /></a> <a href="forum.php?mod=redirect&amp;goto=nextnewset&amp;tid=<?php echo $_G['tid'];?>" title="下一主题"><img src="<?php echo IMGDIR;?>/thread-next.png" alt="下一主题" class="vm" /></a> </div>
                <?php } ?> 
</div>
    ...
    <?php if(!empty($_G['setting']['pluginhooks']['viewthread_postbutton_top'])) echo $_G['setting']['pluginhooks']['viewthread_postbutton_top'];?>
   	<div class="quater_author_info cl">
        <div class="quater_author_info_1 cl">   
                ...
                <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank" class="toux"><?php echo avatar($_G['forum_thread']['authorid'], 'large'); ?></a>
                <?php if($_G['page']==1) { ?>
                <?php if(is_array($postlist)) foreach($postlist as $post) { ?>                    <?php if($post['first']) { ?>
                    <p><a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank" style="color: #2c3e50;"><?php echo $_G['forum_thread']['author'];?></a> <?php echo $authorverifys;?> </p>
                    <p style="margin-top: 3px;"><a href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=<?php echo $post['groupid'];?>" target="_blank" style="color: #b4bbc0; font-size: 13px;"><?php echo $post['authortitle'];?></a></p>
                    <?php } ?>
                <?php } ?>
                <?php } else { ?>
                	<p><a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank"><?php echo $_G['forum_thread']['author'];?></a></p>
                <?php } ?>
                
                <div class="time_thread_stat cl">
 <ul>
                	<li><a><?php echo DB::result_first('SELECT credits FROM '.DB::table('common_member').' WHERE uid ='.$_G['forum_thread']['authorid'].''); ?></a><p>积分</p></li>
                    <li><a><?php echo DB::result_first('SELECT posts FROM '.DB::table('common_member_count').' WHERE uid ='.$_G['forum_thread']['authorid'].''); ?></a><p>帖子</p></li>
                    <li style="border-right: 0;"><a><?php echo DB::result_first('SELECT digestposts FROM '.DB::table('common_member_count').' WHERE uid ='.$_G['forum_thread']['authorid'].''); ?></a><p>精华</p></li>
 </ul>
                </div>
                
                <?php $quater_threadmedal = array();?>                <?php $quater_threadmedal = DB::fetch_all("SELECT medalid FROM ".DB::table('common_member_medal')." where uid=".$_G[forum_thread][authorid]."");?>                <?php if($quater_threadmedal) { ?>
                <div class="viewthread_medal cl">
                    <?php if(is_array($quater_threadmedal)) foreach($quater_threadmedal as $quatermedal) { ?>                        <a href="home.php?mod=medal" title="<?php echo DB::result_first('SELECT name FROM '.DB::table('forum_medal').' WHERE medalid ='.$quatermedal['medalid'].''); ?>: <?php echo DB::result_first('SELECT description FROM '.DB::table('forum_medal').' WHERE medalid ='.$quatermedal['medalid'].''); ?>"><img src="<?php echo STATICURL;?>image/common/<?php echo DB::result_first('SELECT image FROM '.DB::table('forum_medal').' WHERE medalid ='.$quatermedal['medalid'].''); ?>" /></a>
                    <?php } ?>
                </div>
                <?php } ?>
        </div>
...
<ul style="border-top: 0;">
        <?php $time_hotlist = array();?>        <?php $time_hotlist = DB::fetch_all("SELECT tid,views,subject FROM ".DB::table('forum_thread')." where authorid=".$_G[forum_thread][authorid]." and tid !=".$_G[tid]." ORDER BY views DESC limit 10");?><?php if(is_array($time_hotlist)) foreach($time_hotlist as $hotlist) { ?><li><i><span></span></i><a href="forum.php?mod=viewthread&amp;tid=<?php echo $hotlist['tid'];?>" target="_blank"><?php echo $hotlist['subject'];?></a><p></p></li>
<?php } ?>
</ul>
</div>
        </div>
  ...
  <div class="moquu_rrskzx">
      ...
      <div class="moquu_rrbt cl">
        ...
        <?php if($_G['forum_thread']['typeid'] && $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']]) { ?>
            <?php if(!IS_ROBOT && ($_G['forum']['threadtypes']['listable'] || $_G['forum']['status'] == 3)) { ?>
                <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=typeid&amp;typeid=<?php echo $_G['forum_thread']['typeid'];?>" class="colorlink">[<?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>]</a>
            <?php } else { ?>
                [<?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>]
            <?php } ?>
        <?php } ?>
        <?php if($threadsorts && $_G['forum_thread']['sortid']) { ?>
            <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=sortid&amp;sortid=<?php echo $_G['forum_thread']['sortid'];?>" class="colorlink">[<?php echo $_G['forum']['threadsorts']['types'][$_G['forum_thread']['sortid']];?>]</a>
        <?php } ?>
    	<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php echo $fromuid;?>" onclick="return copyThreadUrl(this, '<?php echo $_G['setting']['bbname'];?>')"><?php echo $_G['forum_thread']['subject'];?></a>
        ...
        <?php if($_G['forum_thread']['heatlevel']) { ?>
            <img src="<?php echo $_G['style']['styleimgdir'];?>/icon/hot_<?php echo $_G['forum_thread']['heatlevel'];?>.gif" alt="" title="热度: <?php echo $_G['forum_thread']['heats'];?>" />
        <?php } ?>
        <?php if($_G['forum_thread']['closed'] == 1) { ?>
            <img src="<?php echo $_G['style']['styleimgdir'];?>/icon/lock.png" alt="关闭" title="关闭" class="vm" />
        <?php } ?>
    ...
    <?php if(!empty($_G['setting']['pluginhooks']['viewthread_title_extra'])) echo $_G['setting']['pluginhooks']['viewthread_title_extra'];?>
          ...
          <div class="moquu_small">
            <p><a href="/vip" class=""></a>&copy;                 <?php if($_G['page']==1) { ?>
                <?php if(is_array($postlist)) foreach($postlist as $post) { ?>                    <?php if($post['first']) { ?>
                    <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank" <?php if($post['groupcolor']) { ?> style="color: <?php echo $post['groupcolor'];?>"<?php } ?>><?php echo $_G['forum_thread']['author'];?></a> <?php echo $authorverifys;?>
                	<a href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=<?php echo $post['groupid'];?>" target="_blank"><?php echo $post['authortitle'];?></a>
                    <?php } ?>
                <?php } ?>
                <?php } else { ?>
                	<a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank"><?php echo $_G['forum_thread']['author'];?></a>
                <?php } ?>&nbsp;&nbsp;/&nbsp;&nbsp;<?php echo dgmdate($thread[dateline]);?>&nbsp;&nbsp;/&nbsp;&nbsp;<span style="color: #9aabb8;">
                <a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" title="收藏本帖" class="k_favorite" style="padding-right: 15px;"><i></i><?php echo $_G['forum_thread']['favtimes'];?> 人收藏</a>
...
<?php } elseif(getstatus($post['status'], 5)) { if($showavatars) { ?>
<div>
<div class="avatar avtm"><a href="javascript:;"><?php echo $post['avatar'];?></a></div>
</div>
<?php } } else { } if(($_G['group']['allowedituser'] || $_G['group']['allowbanuser'] || ($_G['forum']['ismoderator'] && $_G['group']['allowviewip'])) && !getstatus($post['status'], 5)) { ?>
<p class="cp_pls cl">
...
<?php } ?>
<td class="plc"<?php if($close_leftinfo) { ?> style="width:100%"<?php } ?>><?php $ad_a_pr=adshow("thread/a_pr/3/$postcount");?><div class="pct"><?php echo adshow("thread/a_pt/2/$postcount");?><?php if(empty($ad_a_pr_css)) { ?>
...
<a href="javascript:;" id="ak_rate" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;" title="评分表立场"><i><img src="<?php echo $_G['style']['styleimgdir'];?>/icon/agree.png" alt="评分" />评分</i></a>
<?php } if(!$post['anonymous'] && $post['first'] && helper_access::check_module('follow')) { ?>
<a class="followp" href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散"><i><img src="<?php echo $_G['style']['styleimgdir'];?>/icon/zhuanbo.png" alt="转播" />转播<?php if($_G['forum_thread']['relay']) { ?><span id="relaynumber" style="display:none"><?php echo $_G['forum_thread']['relay'];?></span><?php } ?></i></a>
<?php } if($post['first'] && helper_access::check_module('share')) { ?>
<a class="sharep" href="home.php?mod=spacecp&amp;ac=share&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" onclick="showWindow('sharethread', this.href, 'get', 0);" title="分享推精华"><i><img src="<?php echo $_G['style']['styleimgdir'];?>/icon/favorite.png" alt="分享" />分享<?php if($_G['forum_thread']['sharetimes']) { ?><span id="sharenumber"><?php echo $_G['forum_thread']['sharetimes'];?></span><?php } ?></i></a>
<?php } if(!$_G['forum']['disablecollect'] && helper_access::check_module('collection')) { ?>
<a href="forum.php?mod=collection&amp;action=edit&amp;op=addthread&amp;tid=<?php echo $_G['tid'];?>" id="k_collect" onclick="showWindow(this.id, this.href);return false;" onmouseover="this.title = $('collectionnumber').innerHTML + ' 人淘帖'" title="淘好帖进专辑"><i><img src="<?php echo $_G['style']['styleimgdir'];?>/icon/taotie.png" alt="分享" />淘帖<span id="collectionnumber"<?php if(!$post['releatcollectionnum']) { ?> style="display:none"<?php } ?>><?php echo $post['releatcollectionnum'];?></span></i></a>
<?php } if(($_G['group']['allowrecommend'] || !$_G['uid']) && $_G['setting']['recommendthread']['status']) { if(!empty($_G['setting']['recommendthread']['addtext'])) { ?>
<a id="recommend_add" href="forum.php?mod=misc&amp;action=recommend&amp;do=add&amp;tid=<?php echo $_G['tid'];?>&amp;hash=<?php echo FORMHASH;?>" <?php if($_G['uid']) { ?>onclick="ajaxmenu(this, 3000, 1, 0, '43', 'recommendupdate(<?php echo $_G['group']['allowrecommend'];?>)');return false;"<?php } else { ?> onclick="showWindow('login', this.href)"<?php } ?> onmouseover="this.title = $('recommendv_add').innerHTML + ' 人<?php echo $_G['setting']['recommendthread']['addtext'];?>'" title="顶一下"><i><img src="<?php echo $_G['style']['styleimgdir'];?>/icon/zan.png" alt="<?php echo $_G['setting']['recommendthread']['addtext'];?>" / style="margin-top: 3px;"><span id="recommendv_add"<?php if(!$_G['forum_thread']['recommend_add']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['recommend_add'];?></span></i></a>
<?php } if(!empty($_G['setting']['recommendthread']['subtracttext'])) { ?>
<a id="recommend_subtract" href="forum.php?mod=misc&amp;action=recommend&amp;do=subtract&amp;tid=<?php echo $_G['tid'];?>&amp;hash=<?php echo FORMHASH;?>" <?php if($_G['uid']) { ?>onclick="ajaxmenu(this, 3000, 1, 0, '43', 'recommendupdate(-<?php echo $_G['group']['allowrecommend'];?>)');return false;"<?php } else { ?> onclick="showWindow('login', this.href)"<?php } ?> onmouseover="this.title = $('recommendv_subtract').innerHTML + ' 人<?php echo $_G['setting']['recommendthread']['subtracttext'];?>'" title="踩一下"><i><img src="<?php echo $_G['style']['styleimgdir'];?>/icon/rec_subtract.png" alt="<?php echo $_G['setting']['recommendthread']['subtracttext'];?>" /><?php echo $_G['setting']['recommendthread']['subtracttext'];?><span id="recommendv_subtract"<?php if(!$_G['forum_thread']['recommend_sub']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['recommend_sub'];?></span></i></a>
<?php } } ?>
...
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" title="收藏本帖" class="k_favorite">收藏</a>
                  <div class="y" style="margin-top: 7px;">
                      <em>
                        <?php if($post['invisible'] == 0) { ?>
                            <?php if($allowpostreply && $post['allowcomment'] && (!$thread['closed'] || $_G['forum']['ismoderator'])) { ?><a class="times_cmmnt" href="forum.php?mod=misc&amp;action=comment&amp;tid=<?php echo $post['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_G['forum_thread']['special'] == 127) { ?>&amp;special=<?php echo $specialextra;?><?php } ?>" onclick="showWindow('comment', this.href, 'get', 0)"><span></span>点评</a><?php } ?>
                        <?php if((!$_G['uid'] || $allowpostreply) && !$needhiddenreply) { ?>
                            <?php if($post['first']) { ?>
                                <a class="times_fastre" href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;reppost=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)"><span></span>回复</a>
                            <?php } else { ?>
                                <a class="times_fastre" href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;repquote=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)"><span></span>回复</a>
                            <?php } ?>
                        <?php } ?>
                        <?php } ?>
                        <?php if((($_G['forum']['ismoderator'] && $_G['group']['alloweditpost'] && (!in_array($post['adminid'], array(1, 2, 3)) || $_G['adminid'] <= $post['adminid'])) || ($_G['forum']['alloweditpost'] && $_G['uid'] && ($post['authorid'] == $_G['uid'] && $_G['forum_thread']['closed'] == 0) && !(!$alloweditpost_status && $edittimelimit && TIMESTAMP - $post['dbdateline'] > $edittimelimit)))) { ?>
                            <a class="times_editp" href="forum.php?mod=post&amp;action=edit&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?><?php if(!empty($_GET['modthreadkey'])) { ?>&amp;modthreadkey=<?php echo $_GET['modthreadkey'];?><?php } ?>&amp;page=<?php echo $page;?>"><span></span><?php if($_G['forum_thread']['special'] == 2 && !$post['message']) { ?>添加柜台介绍<?php } else { ?>编辑</a><?php } ?>
                        <?php } elseif($_G['uid'] && $post['authorid'] == $_G['uid'] && $_G['setting']['postappend']) { ?>
                            <a class="times_appendp" href="forum.php?mod=misc&amp;action=postappend&amp;tid=<?php echo $post['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onClick="showWindow('postappend', this.href, 'get', 0)"><span></span>补充</a>
                        <?php } ?>
                        <?php if($post['first'] && $allowblockrecommend) { ?><a class="times_push" href="javascript:;" onclick="modaction('recommend', '<?php echo $_G['forum_firstpid'];?>', 'op=recommend&idtype=<?php if($_G['forum_thread']['isgroup']) { ?>gtid<?php } else { ?>tid<?php } ?>&id=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'portal.php?mod=portalcp&ac=portalblock')"><span></span>推送</a><?php } ?>
...
<button type="submit" name="replysubmit" id="vreplysubmit" value="true" style="">快速回复</button>		
</div>
...
<td class="plc" style="padding-bottom: 0 !important; box-shadow: none;">
<?php } ?>
...
<div class="cl">
<?php if(empty($_GET['from']) && $_G['setting']['fastsmilies']) { ?><div id="fastsmiliesdiv" class="y" style="margin-top: 30px;"><div id="fastsmiliesdiv_data"><div id="fastsmilies"></div></div></div><?php } ?>
...
EOF;
?>
<div style="margin: 5px 0 0 0;"><?php $sechash = !isset($sechash) ? 'S'.($_G['inajax'] ? 'A' : '').$_G['sid'] : $sechash.random(3);
...
<a class="btn btn-nature y" href="member.php?mod=<?php echo $_G['setting']['regname'];?>" title="立即注册">立即注册</a>
</div>
</div>
    <?php } ?>
...
<?php if($post['tags']) { $tagi = 0;?><?php if(is_array($post['tags'])) foreach($post['tags'] as $var) { if($tagi) { } ?><a title="<?php echo $var['1'];?>" href="misc.php?mod=tag&amp;id=<?php echo $var['0'];?>" target="_blank"><?php echo $var['1'];?></a><?php $tagi++;?><?php } } if($relatedkeywords) { ?><span><?php echo $relatedkeywords;?></span><?php } ?>
</div>
<?php } ?>
        <div id="postlist" class="pl bm postlist_reply">
        <div class="reply_tit cl">
        	<h2><strong><?php echo $_G['forum_thread']['allreplies'];?></strong> 个回复</h2>
            <?php if($_G['forum_thread']['allreplies']) { ?>
            <?php if(!$rushreply) { ?>
                <?php if($ordertype != 1) { ?>
                    <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=1"  class="show z" style="padding-left: 20px; border-left: 1px solid #CCCCCC;">倒序浏览</a>
                <?php } else { ?>
                    <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=2"  class="show z" style="padding-left: 20px; border-left: 1px solid #CCCCCC;">正序浏览</a>
                <?php } ?>
            <?php } ?>
            <?php } ?>
</div>
...
<td class="plc"<?php if($close_leftinfo) { ?> style="width:100%"<?php } ?>>
    <i class="arr"></i>
<div class="pi <?php if($post['first']) { ?>tpi<?php } ?>"<?php if($close_leftinfo || (!$post['first'] && !$post['anonymous'] && $postshowavatars && $showavatars)) { ?> style="height: 50px; padding-bottom: 0; border-bottom: 0;"<?php } ?>>
...
<div class="cl" style="float: left; width: 50px; overflow: hidden;"><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2 z inside_avt" style="padding-right: 0;"><?php echo avatar($post['authorid'], 'middle'); ?></a></div>
                <div class="cl" style="float: right; width: 740px; overflow: hidden;">
                <div class="cl" style="height: 30px; margin: 7px 0 0 0; overflow: hidden;"><?php $_self = $thread['author'] && $post['author'] == $thread['author'] && $post['position'] !== '1';?><?php if($post['authorid'] && !$post['anonymous']) { if(!$_G['setting']['authoronleft']) { ?><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2" >
                    <?php echo $post['author'];?></a><?php echo $authorverifys;?><?php } if($close_leftinfo) { } ?>
<em id="authorposton<?php echo $post['pid'];?>"><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" style="padding: 0 5px 0 0; color: #95a5a6; font-size: 14px; font-weight: bold;"><?php echo $post['author'];?></a><?php echo $authorverifys;?></em>
...
<?php } ?>
                    ...
                    <a href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=<?php echo $post['groupid'];?>" target="_blank" style="padding: 0 10px 0 5px;"><?php echo $post['authortitle'];?></a>
                    <em style="padding: 0 10px 0 0; color: #BBBBBB;"> <?php echo $post['dateline'];?></em>                  
                    <?php if($post['first']) { ?>
                       <span class="ico_reply" style="display: none;"><?php echo $_G['forum_thread']['allreplies'];?></span>
                    <?php } ?>
                    
                    <?php if($post['first']) { ?>
                       <div class="focus_num y" style="margin-top: 1px;"><a><?php echo $_G['forum_thread']['views'];?></a></div>
                    <?php } ?>
...
</div><?php $ad_a_pr=adshow("thread/a_pr/3/$postcount");?><div class="pct" style="padding-left: 60px; color: #515151;"><?php echo adshow("thread/a_pt/2/$postcount");?><?php if(!$_G['inajax']) { if(empty($ad_a_pr_css)) { ?>
<style type="text/css">.pcb{margin-right:0}</style><?php $ad_a_pr_css=1;?><?php } } if(!$post['first'] && $post['replycredit'] > 0) { ?>
<div class="time_cm">
<h3>
回帖奖励 <span class="xw1 xs2 xi1">+<?php echo $post['replycredit'];?></span> <?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['title'];?>
...
<span class="y" style="color: #BBBBBB; font-size: 14px;">
...
<?php if($post['invisible'] == 0) { if((!$_G['uid'] || $allowpostreply) && !$needhiddenreply) { if($post['first']) { ?>
...
<a href="javascript:;" onclick="showWindow('miscreport<?php echo $post['pid'];?>', 'misc.php?mod=report&rtype=post&rid=<?php echo $post['pid'];?>&tid=<?php echo $_G['tid'];?>&fid=<?php echo $_G['fid'];?>', 'get', -1);return false;" style="padding-left: 0;">举报</a>
<?php } } ?>
...
<?php } if($multipage && $page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { $nxtpage = $page + 1;?><div class="pgbtn"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['authorid']) { ?>&amp;authorid=<?php echo $_GET['authorid'];?><?php } ?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true">下一页 &raquo;</a></div>
<?php } ?>
</div>
