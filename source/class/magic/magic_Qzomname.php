 ...
 * 改名道具
 * 改名道具 @ 微动力
 * 改名道具（道具）完美支持好贴吧模板，好贴吧模板体验：http://www.tiebas.com
...
class magic_Qzomname {
	...
	function usesubmit() {
		global $_G;
		if(empty($_GET['gp_newusername'])) {
			showmessage("&#x62B1;&#x6B49;&#xFF0C;&#x4F60;&#x8FD8;&#x6CA1;&#x6709;&#x586B;&#x5199;&#x65B0;&#x7684;&#x7528;&#x6237;&#x540D;");
		}
		$newusername = trim($_GET['gp_newusername']);
		...
		foreach($tables as $table => $conf) {
			DB::query("UPDATE ".DB::table($table)." SET `$conf[name]`='$newusername' WHERE `$conf[id]`='$_GET[uid]'");
		}


			usemagic($this->magic['magicid'], $this->magic['num']);
			updatemagiclog($this->magic['magicid'], '2', '1', '0', 0, 'uid', $_GET['uid']);
